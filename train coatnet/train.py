...
if __name__ == '__main__':
    ...
    parser.add_argument('--opt', default="lion", type=str, metavar='OPTIMIZER',
    ...
    parser.add_argument('--sched', default='linear', type=str, metavar='SCHEDULER',
    ...
    parser.add_argument('--min-lr', type=float, default=1e-5/5, metavar='LR',
    ...
    parser.add_argument('--decay-rate', '--dr', type=float, default=0, metavar='RATE',
    ...
    OPTIMIZER = torch.optim.Adam(BACKBONE.parameters(), lr=1e-3, weight_decay=1e-2)
    print("=" * 60)
    print(OPTIMIZER)
    ...
    if False:
        ...
        if True:
            print("Loading Backbone Checkpoint '{}'".format("model/Backbone_accuracy_[0.9806666666666667, 0.825]_epochs5_batch_514000_checkpoint.pth"))
            BACKBONE.load_state_dict(torch.load("model/Backbone_accuracy_[0.9806666666666667, 0.825]_epochs5_batch_514000_checkpoint.pth"), strict=False)
        print("=" * 60)
